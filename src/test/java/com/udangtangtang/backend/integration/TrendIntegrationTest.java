...
public class TrendIntegrationTest {
    ...
    void trendMap() throws IOException {
        ...
        String text = "게시물 본문1";
        LocationRequestDto locationRequestDto = new LocationRequestDto("{\"roadAddressName\":\"테스트 서귀포시 일주서로 968-10\",\"placeName\":\"테스트\",\"xCoordinate\":\"126.40715814631936\",\"yCoordinate\":\"33.258895288625645\",\"categoryName\":\"음식점 > 일식 > 돈까스,우동\"}");
        ...
        text = "게시물 본문2";
        locationRequestDto = new LocationRequestDto("{\"roadAddressName\":\"테스트 서귀포시 일주서로 968-10\",\"placeName\":\"테스트\",\"xCoordinate\":\"126.40715814631936\",\"yCoordinate\":\"33.258895288625645\",\"categoryName\":\"음식점 > 디저트 > 카페\"}");
        ...
        Article article2 = articleService.createArticle(this.user, text, locationRequestDto, tagNames, imageFiles);
    ...
    void trendChart() throws IOException {
        ...
        String text = "게시물 본문1";
        LocationRequestDto locationRequestDto = new LocationRequestDto("{\"roadAddressName\":\"테스트 서귀포시 일주서로 968-10\",\"placeName\":\"테스트\",\"xCoordinate\":\"126.40715814631936\",\"yCoordinate\":\"33.258895288625645\",\"categoryName\":\"음식점 > 일식 > 음식점\"}");
        List<String> tagNames = Arrays.asList("얌얌트랜드", "음식", "사진", "공유");
        List<MultipartFile> imageFiles = Arrays.asList(
                getMockMultipartFile("cute_chun_sik", "jpeg", "multipart/form-data", "src/test/resources/images/cute_chun_sik.jpeg"),
                getMockMultipartFile("ring_ding_kermit", "jpeg", "multipart/form-data", "src/test/resources/images/ring_ding_kermit.jpeg")
        ...
        text = "게시물 본문2";
        locationRequestDto = new LocationRequestDto("{\"roadAddressName\":\"테스트 서귀포시 일주서로 968-10\",\"placeName\":\"테스트\",\"xCoordinate\":\"126.40715814631936\",\"yCoordinate\":\"33.258895288625645\",\"categoryName\":\"음식점 > 디저트 > 음식점\"}");
        tagNames = Arrays.asList("얌얌트랜드2", "음식2", "사진2", "공유2");
        imageFiles = Arrays.asList(
                getMockMultipartFile("cute_chun_sik", "jpeg", "multipart/form-data", "src/test/resources/images/cute_chun_sik.jpeg"),
                getMockMultipartFile("ring_ding_kermit", "jpeg", "multipart/form-data", "src/test/resources/images/ring_ding_kermit.jpeg")
        ...
        String location = "테스트";
        // when
        List<TrendResponseDto> dto = trendService.getChartTrendData(location);
    ...
    void trendTagChart() throws IOException {
        ...
        String location = "";
        // when
        List<TrendResponseDto> dto = trendService.getTagChartTrendData(location);
